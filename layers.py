#overwrite it here tf_slim/layers/layers.py
#https://github.com/google-research/tf-slim/blob/277dab3d20d6207cf119a2ddf2161c61ebf06b16/tf_slim/layers/layers.py
# coding=utf-8
# -*- coding: utf-8 -*-
